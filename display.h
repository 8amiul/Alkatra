...
enum screens {HOME, MENU, MUSIC, CALC, GAMES, CAL, ESPFETCH, EQnGEN, BOOK, WIFI, KEYBOARD};
enum icon {MUSIC_ICO, CALC_ICO, GAMES_ICO, CAL_ICO, ESPFETCH_ICO, EQnGEN_ICO, BOOK_ICO, WIFI_ICO};
